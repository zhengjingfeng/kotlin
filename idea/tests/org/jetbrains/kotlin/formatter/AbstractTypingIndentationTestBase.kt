...
abstract class AbstractTypingIndentationTestBase : KotlinLightPlatformCodeInsightTestCase() {
    ...
    private fun assertCustomIndentExist(withoutCustomLineIndentProvider: Boolean) {
        val offset = editor_.caretModel.offset
        runWriteAction {
            editor_.document.insertString(offset, "\n")
        }

        val customIndent = customLineIndentProvider.getLineIndent(project_, editor_, KotlinLanguage.INSTANCE, offset + 1)
